function buildHome() {
    ...
    $('div#col_title div').append('<img class=center-block src=https://webjump.com.br/wp-content/uploads/2021/12/webjump-compass-2x-min-200x67.png></img>');
...
function addImages() {
    ...
    $('#panel_body_three').append('<img class=img-responsive alt=html_css_js src=https://www.neonexus.com.br/wp-content/uploads/2018/01/29488525-f55a69d0-84da-11e7-8a39-5476f663b5eb.png></img>');
    $('#panel_body_three').append('<img class=img-responsive-center-block alt=magento src=https://webjump.com.br/wp-content/uploads/2021/07/badge-enterprise-magento2-min.png></img>');
    $('#panel_body_three').append('<img class=img-responsive-center-block alt=selenium src=https://i.imgur.com/1vsaEJB.jpg></img>');
}
